...
Revision ID: f428e9bb1bb2
Revises:
Create Date: 2024-02-09 14:55:44.204499
...
def upgrade() -> None:
    op.execute("CREATE SCHEMA alertswisscap;")
    ...
    op.create_table(
        ...
        sa.Column("cap_description", sa.String(), nullable=False),
...
def downgrade() -> None:
    ...
    op.execute("DROP SCHEMA alertswisscap;")
    # ### end Alembic commands ###
