...
def upgrade() -> None:
    ...
    op.create_table('cap_linestrings',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index('idx_cap_linestrings_geom', table_name='cap_linestrings', postgresql_using='gist')
