...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("cap_event_de", sa.String(), nullable=True),
        sa.Column("cap_event_fr", sa.String(), nullable=True),
        sa.Column("cap_event_it", sa.String(), nullable=True),
        sa.Column("cap_event_en", sa.String(), nullable=True),
